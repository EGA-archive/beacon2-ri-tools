...
sub read_config_file {
    ...
    my $NGSutils_dir = '/media/mrueda/4TB/NGSutils';
    my %NGSutils     = (
...
'/media/mrueda/4TB/Soft/mongodb-database-tools-ubuntu2004-x86_64-100.5.1/bin/';
    my %mongodb_db_tools = (
